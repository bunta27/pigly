    ...
    <main>
        <div class="card status">
            ...
            <div class="status-value">
                <span class="status-number">{{ number_format($target->target_weight,1) }}</span>
        ...
        <div class="card status">
            ...
            <div class="status-value">
                <span class="status-number">{{ $toGoal !== null ? number_format($toGoal,1) : '-' }}</span>
                <span class="status-unit">kg</span>
            </div>
        </div>
        <div class="card status">
            ...
            <div class="status-value">
                <span class="status-number">{{ $latestWeight !== null ? number_format($latestWeight,1) : '-' }}</span>
                <span class="status-unit">kg</span>
            </div>
        </div>
        ...
        <div class="toolbar">
            <form method="get" class="filter">
                ...
                <button type="hidden" class="button btn-reset">リセット</button>
                <button class="button btn-primary">データ追加</button>
            </form>
        </div>
                ...
                <tbody>
                    @foreach ($logs as $log)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('weight_logs, $log->id) }}" class="button btn-edit">
                                    <img src="{{ asset('icons/pen.svg') }}" alt="Edit" class="icon">
                                </a>
                            </td>
                        </tr>
                    @endforeach
